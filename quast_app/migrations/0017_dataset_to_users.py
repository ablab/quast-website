...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSet.user_session'
        db.add_column('quast_app_dataset', 'user_session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quast_app.UserSession'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'QuastSession.date'
        db.alter_column('quast_app_quastsession', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'ContigsFile.user_session'
        db.delete_column('quast_app_contigsfile', 'user_session_id')


    def backwards(self, orm):
        # Deleting field 'DataSet.user_session'
        db.delete_column('quast_app_dataset', 'user_session_id')


        # Changing field 'QuastSession.date'
        db.alter_column('quast_app_quastsession', 'date', self.gf('django.db.models.fields.DateTimeField')(default=None))
        # Adding field 'ContigsFile.user_session'
        db.add_column('quast_app_contigsfile', 'user_session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quast_app.UserSession'], null=True, blank=True),
                      keep_default=False)
