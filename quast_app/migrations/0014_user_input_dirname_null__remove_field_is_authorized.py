...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'User', fields ['input_dirname']
        db.delete_unique('quast_app_user', ['input_dirname'])

        # Changing field 'User.input_dirname'
        db.alter_column('quast_app_user', 'input_dirname', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):
        # Changing field 'User.input_dirname'
        db.alter_column('quast_app_user', 'input_dirname', self.gf('django.db.models.fields.CharField')(default=None, max_length=256, unique=True))

        # Adding unique constraint on 'User', fields ['input_dirname']
        db.create_unique('quast_app_user', ['input_dirname'])
