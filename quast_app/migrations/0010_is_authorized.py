...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSession.is_authorised'
        db.add_column('quast_app_usersession', 'is_authorised',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSession.is_authorised'
        db.delete_column('quast_app_usersession', 'is_authorised')
