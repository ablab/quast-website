...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuastSession.submited'
        db.add_column('quast_app_quastsession', 'submited',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuastSession.submited'
        db.delete_column('quast_app_quastsession', 'submited')
