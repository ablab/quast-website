...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContigsFile.user_session'
        db.alter_column('quast_app_contigsfile', 'user_session_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quast_app.UserSession'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ContigsFile.user_session'
        db.alter_column('quast_app_contigsfile', 'user_session_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['quast_app.UserSession']))
    ...
    models = {
        ...
        'quast_app.quastsession': {
            ...
            'report_id': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': 'None'}),
