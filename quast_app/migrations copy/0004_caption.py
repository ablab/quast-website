...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuastSession.caption'
        db.add_column('quast_app_quastsession', 'caption',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuastSession.caption'
        db.delete_column('quast_app_quastsession', 'caption')
