...
VIRTUALENV_PATH             = os.path.join(SOURCE_DIRPATH, 'virtualenv')
...
GLOSSARY_PATH               = os.path.join(QUAST_DIRPATH, 'quast_libs/html_saver/glossary.json')
ICARUS_SCRIPT_FPATH         = os.path.join(QUAST_DIRPATH, 'quast_libs/html_saver/static/scripts/build_icarus.js')
...
ABOUT_FPATH                = os.path.join(APP_DIRPATH, 'about.html')
...
REPORT_LINK_BASE            = '/quast/reports/'
...
SUPPORT_EMAIL = 'quast.support@cab.spbu.ru'
...
STATICFILES_DIRS = [
    ...
    os.path.join(QUAST_DIRPATH, 'quast_libs/html_saver/static'),
]
